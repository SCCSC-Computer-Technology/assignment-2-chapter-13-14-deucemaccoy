...
namespace andrew_foster_cpt_236_lab_1
{
    public partial class Form1 : Form
    {
        ...
        //variable to hold the results of each search
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            //initialize the form and disable the additional text fields that are not in focus
        }
        ...
        private void Error()
        {
            ...
            //function to generate error messages when needed
        }
        ...
        private void pNumRadio_CheckedChanged(object sender, EventArgs e)
        {
            if (pNumRadio.Checked == true)
            {
                ...
                //all radio buttons disable unnecessary text fields to prevent additonal data from being processed by accident
            }
        }
        ...
        private void pSearch_Click(object sender, EventArgs e)
        {
            ...
            if (pNumText.Text.Length > 0)
            {
                ...
                //search by product number and display results
            }
            else if (pDescText.Text.Length > 0)
            {
                ...
                //search by description and display results
            }
            if (resultsList.Items.Count < 1) { Error(); }
            //display an error message if results list is blank
